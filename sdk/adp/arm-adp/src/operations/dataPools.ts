...
export class DataPoolsImpl implements DataPools {
  ...
  private async *listPagingPage(
    ...
    let result: DataPoolsListResponse;
  ...
  async beginUpdate(
    ...
    SimplePollerLike<
      OperationState<DataPoolsUpdateResponse>,
      DataPoolsUpdateResponse
    >
  > {
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, accountName, dataPoolName, options },
  ...
  async beginCreateOrUpdate(
    ...
    SimplePollerLike<
      OperationState<DataPoolsCreateOrUpdateResponse>,
      DataPoolsCreateOrUpdateResponse
    >
  > {
    const directSendOperation = async (
