...
import {
  ...
  LoadBalancersRebalanceOptionalParams,
  LoadBalancersRebalanceResponse,
...
export class LoadBalancersImpl implements LoadBalancers {
   ...
   * @param options The options parameters.
   */
  async beginRebalance(
    resourceGroupName: string,
    resourceName: string,
    parameters: RebalanceLoadBalancersRequestBody,
    options?: LoadBalancersRebalanceOptionalParams,
  ): Promise<
    SimplePollerLike<
      OperationState<LoadBalancersRebalanceResponse>,
      LoadBalancersRebalanceResponse
    >
  > {
    ...
    ): Promise<LoadBalancersRebalanceResponse> => {
   ...
   * @param options The options parameters.
   */
  async beginRebalanceAndWait(
    resourceGroupName: string,
    resourceName: string,
    parameters: RebalanceLoadBalancersRequestBody,
    options?: LoadBalancersRebalanceOptionalParams,
  ): Promise<LoadBalancersRebalanceResponse> {
    const poller = await this.beginRebalance(
      resourceGroupName,
      resourceName,
      parameters,
      options,
...
const rebalanceOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      headersMapper: Mappers.LoadBalancersRebalanceHeaders,
    },
    201: {
      headersMapper: Mappers.LoadBalancersRebalanceHeaders,
    },
