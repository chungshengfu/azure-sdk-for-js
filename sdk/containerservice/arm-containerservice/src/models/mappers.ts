...
export const NetworkMonitoring: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "NetworkMonitoring",
    modelProperties: {
...
export const SafeguardsProfile: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "SafeguardsProfile",
    modelProperties: {
...
export const ManagedCluster: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      safeguardsProfile: {
        serializedName: "properties.safeguardsProfile",
        type: {
          name: "Composite",
          className: "SafeguardsProfile",
        },
...
export const LoadBalancersRebalanceHeaders: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "LoadBalancersRebalanceHeaders",
    modelProperties: {
      location: {
        serializedName: "location",
        type: {
