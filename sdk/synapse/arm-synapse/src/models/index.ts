...
/** Defines headers for KustoPools_update operation. */
export interface KustoPoolsUpdateHeaders {
  location?: string;
}

/** Defines headers for KustoPools_delete operation. */
export interface KustoPoolsDeleteHeaders {
  location?: string;
}

/** Defines headers for KustoPools_stop operation. */
export interface KustoPoolsStopHeaders {
  location?: string;
}

/** Defines headers for KustoPools_start operation. */
export interface KustoPoolsStartHeaders {
  location?: string;
}

/** Defines headers for KustoPools_migrate operation. */
export interface KustoPoolsMigrateHeaders {
  location?: string;
}

/** Defines headers for KustoPools_addLanguageExtensions operation. */
export interface KustoPoolsAddLanguageExtensionsHeaders {
  location?: string;
}

/** Defines headers for KustoPools_removeLanguageExtensions operation. */
export interface KustoPoolsRemoveLanguageExtensionsHeaders {
  location?: string;
}

/** Defines headers for KustoPools_detachFollowerDatabases operation. */
export interface KustoPoolsDetachFollowerDatabasesHeaders {
  location?: string;
}

/** Defines headers for KustoPoolAttachedDatabaseConfigurations_createOrUpdate operation. */
export interface KustoPoolAttachedDatabaseConfigurationsCreateOrUpdateHeaders {
  location?: string;
}

/** Defines headers for KustoPoolAttachedDatabaseConfigurations_delete operation. */
export interface KustoPoolAttachedDatabaseConfigurationsDeleteHeaders {
  location?: string;
}

/** Defines headers for KustoPoolDatabases_update operation. */
export interface KustoPoolDatabasesUpdateHeaders {
  location?: string;
}

/** Defines headers for KustoPoolDatabases_delete operation. */
export interface KustoPoolDatabasesDeleteHeaders {
  location?: string;
}

/** Defines headers for KustoPoolDataConnections_dataConnectionValidation operation. */
export interface KustoPoolDataConnectionsDataConnectionValidationHeaders {
  location?: string;
}

/** Defines headers for KustoPoolDataConnections_update operation. */
export interface KustoPoolDataConnectionsUpdateHeaders {
  location?: string;
}

/** Defines headers for KustoPoolDataConnections_delete operation. */
export interface KustoPoolDataConnectionsDeleteHeaders {
  location?: string;
}

/** Defines headers for KustoPoolPrincipalAssignments_delete operation. */
export interface KustoPoolPrincipalAssignmentsDeleteHeaders {
  location?: string;
}

/** Defines headers for KustoPoolDatabasePrincipalAssignments_delete operation. */
export interface KustoPoolDatabasePrincipalAssignmentsDeleteHeaders {
  location?: string;
}
...
/** Optional parameters. */
export interface KustoPoolsMigrateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface KustoPoolDatabaseInviteFollowerOptionalParams
  extends coreClient.OperationOptions {}
