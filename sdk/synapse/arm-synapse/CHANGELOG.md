...
**Features**
  ...
  - Added operation group KustoPoolDatabase
  ...
  - Added operation KustoPools.beginMigrate
  - Added operation KustoPools.beginMigrateAndWait
  ...
  - Added Interface KustoPoolAttachedDatabaseConfigurationsCreateOrUpdateHeaders
  - Added Interface KustoPoolAttachedDatabaseConfigurationsDeleteHeaders
  - Added Interface KustoPoolDatabaseInviteFollowerOptionalParams
  - Added Interface KustoPoolDatabasePrincipalAssignmentsDeleteHeaders
  - Added Interface KustoPoolDatabasesDeleteHeaders
  - Added Interface KustoPoolDatabasesUpdateHeaders
  - Added Interface KustoPoolDataConnectionsDataConnectionValidationHeaders
  - Added Interface KustoPoolDataConnectionsDeleteHeaders
  - Added Interface KustoPoolDataConnectionsUpdateHeaders
  - Added Interface KustoPoolMigrateRequest
  - Added Interface KustoPoolPrincipalAssignmentsDeleteHeaders
  - Added Interface KustoPoolPrivateLinkResources
  - Added Interface KustoPoolPrivateLinkResourcesListOptionalParams
  - Added Interface KustoPoolsAddLanguageExtensionsHeaders
  - Added Interface KustoPoolsDeleteHeaders
  - Added Interface KustoPoolsDetachFollowerDatabasesHeaders
  - Added Interface KustoPoolsMigrateHeaders
  - Added Interface KustoPoolsMigrateOptionalParams
  - Added Interface KustoPoolsRemoveLanguageExtensionsHeaders
  - Added Interface KustoPoolsStartHeaders
  - Added Interface KustoPoolsStopHeaders
  - Added Interface KustoPoolsUpdateHeaders
  ...
  - Added Type Alias KustoPoolDatabaseInviteFollowerResponse
