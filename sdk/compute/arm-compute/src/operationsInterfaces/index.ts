...
export * from "./gallerySecurityPostures";
export * from "./gallerySecurityPostureVersions";
...
export * from "./communityGallerySecurityPostures";
export * from "./communityGallerySecurityPostureVersions";
