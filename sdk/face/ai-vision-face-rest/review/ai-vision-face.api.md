...
export interface Routes {
    (path: "/face/{apiVersion}/operations/{operationId}", apiVersion: string, operationId: string): GetFaceOperationStatus;
    (path: "/face/{apiVersion}/detect", apiVersion: string): Detect;
    (path: "/face/{apiVersion}/findsimilars", apiVersion: string): FindSimilar;
    (path: "/face/{apiVersion}/identify", apiVersion: string): IdentifyFromPersonGroup;
    (path: "/face/{apiVersion}/verify", apiVersion: string): VerifyFaceToFace;
    (path: "/face/{apiVersion}/group", apiVersion: string): Group;
    (path: "/face/{apiVersion}/facelists/{faceListId}", apiVersion: string, faceListId: string): CreateFaceList;
    (path: "/face/{apiVersion}/facelists", apiVersion: string): GetFaceLists;
    (path: "/face/{apiVersion}/facelists/{faceListId}/persistedfaces", apiVersion: string, faceListId: string): AddFaceListFace;
    (path: "/face/{apiVersion}/facelists/{faceListId}/persistedfaces/{persistedFaceId}", apiVersion: string, faceListId: string, persistedFaceId: string): DeleteFaceListFace;
    (path: "/face/{apiVersion}/largefacelists/{largeFaceListId}", apiVersion: string, largeFaceListId: string): CreateLargeFaceList;
    (path: "/face/{apiVersion}/largefacelists", apiVersion: string): GetLargeFaceLists;
    (path: "/face/{apiVersion}/largefacelists/{largeFaceListId}/training", apiVersion: string, largeFaceListId: string): GetLargeFaceListTrainingStatus;
    (path: "/face/{apiVersion}/largefacelists/{largeFaceListId}/train", apiVersion: string, largeFaceListId: string): TrainLargeFaceList;
    (path: "/face/{apiVersion}/largefacelists/{largeFaceListId}/persistedfaces", apiVersion: string, largeFaceListId: string): AddLargeFaceListFace;
    (path: "/face/{apiVersion}/largefacelists/{largeFaceListId}/persistedfaces/{persistedFaceId}", apiVersion: string, largeFaceListId: string, persistedFaceId: string): DeleteLargeFaceListFace;
    (path: "/face/{apiVersion}/persongroups/{personGroupId}", apiVersion: string, personGroupId: string): CreatePersonGroup;
    (path: "/face/{apiVersion}/persongroups", apiVersion: string): GetPersonGroups;
    (path: "/face/{apiVersion}/persongroups/{personGroupId}/training", apiVersion: string, personGroupId: string): GetPersonGroupTrainingStatus;
    (path: "/face/{apiVersion}/persongroups/{personGroupId}/train", apiVersion: string, personGroupId: string): TrainPersonGroup;
    (path: "/face/{apiVersion}/persongroups/{personGroupId}/persons", apiVersion: string, personGroupId: string): CreatePersonGroupPerson;
    (path: "/face/{apiVersion}/persongroups/{personGroupId}/persons/{personId}", apiVersion: string, personGroupId: string, personId: string): DeletePersonGroupPerson;
    (path: "/face/{apiVersion}/persongroups/{personGroupId}/persons/{personId}/persistedfaces", apiVersion: string, personGroupId: string, personId: string): AddPersonGroupPersonFace;
    (path: "/face/{apiVersion}/persongroups/{personGroupId}/persons/{personId}/persistedfaces/{persistedFaceId}", apiVersion: string, personGroupId: string, personId: string, persistedFaceId: string): DeletePersonGroupPersonFace;
    (path: "/face/{apiVersion}/largepersongroups/{largePersonGroupId}", apiVersion: string, largePersonGroupId: string): CreateLargePersonGroup;
    (path: "/face/{apiVersion}/largepersongroups", apiVersion: string): GetLargePersonGroups;
    (path: "/face/{apiVersion}/largepersongroups/{largePersonGroupId}/training", apiVersion: string, largePersonGroupId: string): GetLargePersonGroupTrainingStatus;
    (path: "/face/{apiVersion}/largepersongroups/{largePersonGroupId}/train", apiVersion: string, largePersonGroupId: string): TrainLargePersonGroup;
    (path: "/face/{apiVersion}/largepersongroups/{largePersonGroupId}/persons", apiVersion: string, largePersonGroupId: string): CreateLargePersonGroupPerson;
    (path: "/face/{apiVersion}/largepersongroups/{largePersonGroupId}/persons/{personId}", apiVersion: string, largePersonGroupId: string, personId: string): DeleteLargePersonGroupPerson;
    (path: "/face/{apiVersion}/largepersongroups/{largePersonGroupId}/persons/{personId}/persistedfaces", apiVersion: string, largePersonGroupId: string, personId: string): AddLargePersonGroupPersonFace;
    (path: "/face/{apiVersion}/largepersongroups/{largePersonGroupId}/persons/{personId}/persistedfaces/{persistedFaceId}", apiVersion: string, largePersonGroupId: string, personId: string, persistedFaceId: string): DeleteLargePersonGroupPersonFace;
    (path: "/face/{apiVersion}/persons", apiVersion: string): CreatePerson;
    (path: "/face/{apiVersion}/persons/{personId}", apiVersion: string, personId: string): DeletePerson;
    (path: "/face/{apiVersion}/persons/{personId}/dynamicPersonGroupReferences", apiVersion: string, personId: string): GetDynamicPersonGroupReferences;
    (path: "/face/{apiVersion}/persons/{personId}/recognitionModels/{recognitionModel}/persistedfaces", apiVersion: string, personId: string, recognitionModel: object): AddPersonFace;
    (path: "/face/{apiVersion}/persons/{personId}/recognitionModels/{recognitionModel}/persistedfaces/{persistedFaceId}", apiVersion: string, personId: string, recognitionModel: object, persistedFaceId: string): DeletePersonFace;
    (path: "/face/{apiVersion}/dynamicpersongroups/{dynamicPersonGroupId}", apiVersion: string, dynamicPersonGroupId: string): CreateDynamicPersonGroup;
    (path: "/face/{apiVersion}/dynamicpersongroups", apiVersion: string): GetDynamicPersonGroups;
    (path: "/face/{apiVersion}/dynamicpersongroups/{dynamicPersonGroupId}/persons", apiVersion: string, dynamicPersonGroupId: string): GetDynamicPersonGroupPersons;
    (path: "/face/{apiVersion}/detectLiveness/singleModal/sessions", apiVersion: string): CreateLivenessSession;
    (path: "/face/{apiVersion}/detectLiveness/singleModal/sessions/{sessionId}", apiVersion: string, sessionId: string): DeleteLivenessSession;
    (path: "/face/{apiVersion}/detectLiveness/singleModal/sessions/{sessionId}/audit", apiVersion: string, sessionId: string): GetLivenessSessionAuditEntries;
    (path: "/face/{apiVersion}/detectLivenessWithVerify/singleModal/sessions", apiVersion: string): CreateLivenessWithVerifySessionWithVerifyImage;
    (path: "/face/{apiVersion}/detectLivenessWithVerify/singleModal/sessions/{sessionId}", apiVersion: string, sessionId: string): DeleteLivenessWithVerifySession;
    (path: "/face/{apiVersion}/detectLivenessWithVerify/singleModal/sessions/{sessionId}/audit", apiVersion: string, sessionId: string): GetLivenessWithVerifySessionAuditEntries;
}
