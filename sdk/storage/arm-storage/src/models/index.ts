...
export interface LocalUserListResult {
  /** List of local users requested. */
  value?: LocalUser[];
  /**
...
export interface StorageTaskAssignmentExecutionContext {
  ...
  /** Execution constraints of the storage task assignment */
...
export interface ExecutionTarget {
  ...
  prefix: string[];
  /** List of target prefixes to exclude */
  excludePrefix?: string[];
...
export interface ExecutionConstraints {
  /** abortOnFailures constraint for storage task assignment execution */
  abortOnFailures?: number;
}
...
/** Target for storage task assignment update execution */
export interface ExecutionTargetUpdate {
  /** List of target prefixes */
  prefix?: string[];
  /** List of target prefixes to exclude */
  excludePrefix?: string[];
...
export interface StorageTaskAssignment extends ResourceAutoGenerated {
  /** Id of the corresponding storage task */
  taskId?: string;
  /** Whether the storage task assignment is enabled or not */
  enabled?: boolean;
...
/** Contains response data for the list operation. */
export type LocalUsersListResponse = LocalUserListResult;
