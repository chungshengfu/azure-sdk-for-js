...
export const LocalUserListResult: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "LocalUserListResult",
    modelProperties: {
      value: {
        serializedName: "value",
        type: {
    ...
    type: {
      ...
      modelProperties: {
        ...
        constraints: {
          ...
          type: {
            name: "Composite",
            className: "ExecutionConstraints",
          },
        },
      },
    },
...
export const ExecutionTarget: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      reservedPathPrefix: {
        serializedName: "reservedPathPrefix",
        type: {
          name: "Sequence",
          element: {
            type: {
...
export const ExecutionConstraints: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ExecutionConstraints",
    modelProperties: {
      abortOnFailures: {
        ...
        serializedName: "abortOnFailures",
        type: {
          name: "Number",
        },
      },
