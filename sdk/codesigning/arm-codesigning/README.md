...
[Source code](https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/codesigning/arm-codesigning) |
[Package (NPM)](https://www.npmjs.com/package/@azure/arm-codesigning) |
[API reference documentation](https://docs.microsoft.com/javascript/api/@azure/arm-codesigning?view=azure-node-preview) |
...
```javascript
const { CodeSigningManagementClient } = require("@azure/arm-codesigning");
...
![Impressions](https://azure-sdk-impressions.azurewebsites.net/api/impressions/azure-sdk-for-js%2Fsdk%2Fcodesigning%2Farm-codesigning%2FREADME.png)
