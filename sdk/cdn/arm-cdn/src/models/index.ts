...
export interface AFDEndpointPropertiesUpdateParameters {
  ...
  /** A reference to the origin group. The dedicated vip is created as a separate resource. The dedicated vip will be linked to an endpoint for L4 profiles */
...
export interface AFDOriginGroupUpdatePropertiesParameters {
  ...
  /** The type of L7 or L4 route to use for this origin group. Valid options are 'L7Route' or 'L4Route'. This will help validate L4 origin groups with L4 routes */
  routeType?: RouteType;
}
...
export interface HealthProbeParameters {
  ...
  /** The valid range of ports for health probes for TCP/UDP would typically be from 1024-65535. This range excludes the reserved ports and allows for a wide range of available ports to use for health probes */
  probePort?: number;
...
export interface AFDOriginUpdatePropertiesParameters {
  ...
  /** The ports used for the TCP/UDP connection to the customer's backend. Must be between 1024 and 65535 excluding reserved ports. The ports can be a comma separated list or a valid range like 5050-5090 */
  originPorts?: string;
  /** Preserves the client side source IP allowing the back-end to see the IP address of the client. This can then be used by applications for applying any rules. Valid options are 'Enabled' or 'Disabled' */
...
/** Result of the request to list L4 routes. It contains a list of L4 route objects and a URL link to get the next set of results. */
...
export interface L4RouteUpdatePropertiesParameters {
  /** Routing method for TCP/UDP routes based on SNI or Ports division, if it is SNI based then the we can read SNI header to get the origin name or if its based on the ports then we can have port division to connect to specific origin for example port range 2000-2050 belongs to origin group 1 and port range 3000-3050 belongs to origin group 2. */
...
export interface L4RouteBaseSettings {
  ...
  /** The ports used for the TCP/UDP connection. Must be between 1024 and 65535 excluding reserved ports. The ports can be a comma separated list or a valid range like 5050-5090 */
  ports?: string;
}
...
export interface L4RouteProperties
  extends L4RouteUpdatePropertiesParameters,
    AFDStateProperties {}
...
/** Defines headers for L4Routes_create operation. */
export interface L4RoutesCreateHeaders {
  location?: string;
}

/** Defines headers for L4Routes_update operation. */
export interface L4RoutesUpdateHeaders {
  location?: string;
}

/** Defines headers for L4Routes_delete operation. */
...
/** Known values of {@link SessionAffinityType} that the service accepts. */
...
/**
 * Defines values for SessionAffinityType. \
 * {@link KnownSessionAffinityType} can be used interchangeably with SessionAffinityType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **SourceIP** \
 * **None**
...
/** Known values of {@link ClientIPPreservationState} that the service accepts. */
...
/**
 * Defines values for ClientIPPreservationState. \
 * {@link KnownClientIPPreservationState} can be used interchangeably with ClientIPPreservationState,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Enabled** \
 * **Disabled**
...
/** Known values of {@link RoutingMethod} that the service accepts. */
...
/**
 * Defines values for RoutingMethod. \
...
/** Known values of {@link FrontendProtocol} that the service accepts. */
...
/**
 * Defines values for FrontendProtocol. \
 * {@link KnownFrontendProtocol} can be used interchangeably with FrontendProtocol,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **TCP** \
 * **UDP**
...
/** Optional parameters. */
export interface L4RoutesListByEndpointOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface L4RoutesGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface L4RoutesCreateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface L4RoutesUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface L4RoutesDeleteOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Optional parameters. */
export interface L4RoutesListByEndpointNextOptionalParams
  extends coreClient.OperationOptions {}
