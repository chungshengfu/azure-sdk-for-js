  ...
  type: {
    ...
    modelProperties: {
      ...
      layerSelector: {
        ...
        type: {
          name: "Composite",
          className: "OCIRepositoryLayerSelectorDefinition",
        },
      },
      verify: {
        ...
        type: {
          name: "Composite",
          className: "OCIRepositoryVerifyDefinition",
        },
      },
      serviceAccountName: {
...
export const OCIRepositoryLayerSelectorDefinition: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "OCIRepositoryLayerSelectorDefinition",
...
export const OCIRepositoryVerifyDefinition: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "OCIRepositoryVerifyDefinition",
    modelProperties: {
  ...
  type: {
    ...
    modelProperties: {
      ...
      layerSelector: {
        ...
        type: {
          name: "Composite",
          className: "OCIRepositoryLayerSelectorPatchDefinition",
        },
      },
      verify: {
        serializedName: "verify",
        type: {
          name: "Composite",
          className: "OCIRepositoryVerifyPatchDefinition",
        },
      },
      serviceAccountName: {
        serializedName: "serviceAccountName",
...
export const OCIRepositoryLayerSelectorPatchDefinition: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "OCIRepositoryLayerSelectorPatchDefinition",
...
export const OCIRepositoryVerifyPatchDefinition: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "OCIRepositoryVerifyPatchDefinition",
    modelProperties: {
