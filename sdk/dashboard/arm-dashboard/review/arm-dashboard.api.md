...
export interface EnterpriseDetailsOperations {
    post(resourceGroupName: string, workspaceName: string, options?: EnterpriseDetailsPostOptionalParams): Promise<EnterpriseDetailsPostResponse>;
}

// @public
export interface EnterpriseDetailsPostOptionalParams extends coreClient.OperationOptions {
}
