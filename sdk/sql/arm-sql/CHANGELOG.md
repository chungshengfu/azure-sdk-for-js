...
**Features**
  ...
  - Added Interface RecommendedActionAutoGenerated
  ...
  - Interface RecommendedAction has a new optional parameter id
  - Interface RecommendedAction has a new optional parameter name
  - Interface RecommendedAction has a new optional parameter type
...
**Breaking Changes**
  ...
  - Interface ExportDatabaseDefinition no longer has parameter networkIsolation
  - Interface ImportExistingDatabaseDefinition no longer has parameter networkIsolation
