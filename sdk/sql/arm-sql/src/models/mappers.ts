...
export const DistributedAvailabilityGroupsCreateOrUpdateRequestBody: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "DistributedAvailabilityGroupsCreateOrUpdateRequestBody",
    modelProperties: {
      targetDatabase: {
...
export const RecommendedActionAutoGenerated: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "RecommendedActionAutoGenerated",
    modelProperties: {
      ...ProxyResource.type.modelProperties,
      kind: {
        serializedName: "kind",
