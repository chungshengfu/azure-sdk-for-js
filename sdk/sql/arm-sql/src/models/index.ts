...
export interface DatabaseBillingVersionResponse extends ProxyResource {
...
export interface Database extends TrackedResource {
   ...
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly hyperscaleBillingVersion?: HyperscaleBillingVersion;
  /**
   * The max log size for this database.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
export type AutomaticTuningDisabledReason =
  ...
  | "QueryStoreReadOnly"
  | "NotSupported";
/** Defines values for DatabaseBillingVersion. */
export type DatabaseBillingVersion = 1 | 2;
...
/** Defines values for HyperscaleBillingVersion. */
export type HyperscaleBillingVersion = 1 | 2;
...
/** Optional parameters. */
export interface DatabaseBillingVersionCreateOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the create operation. */
export type DatabaseBillingVersionCreateResponse =
