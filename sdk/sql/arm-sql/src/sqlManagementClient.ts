...
export class SqlManagementClient extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    const packageDetails = `azsdk-js-arm-sql/1.0.0-beta.1`;
    ...
    this.databaseBillingVersion = new DatabaseBillingVersionImpl(this);
  ...
  databaseBillingVersion: DatabaseBillingVersion;
