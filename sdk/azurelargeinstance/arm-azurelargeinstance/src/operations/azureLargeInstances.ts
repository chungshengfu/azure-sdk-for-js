...
import {
  ...
  AzureLargeInstancesDeleteResponse,
...
export class AzureLargeInstancesImpl implements AzureLargeInstances {
  ...
  async beginDelete(
    ...
    SimplePollerLike<
      OperationState<AzureLargeInstancesDeleteResponse>,
      AzureLargeInstancesDeleteResponse
    >
  > {
    const directSendOperation = async (
      args: coreClient.OperationArguments,
      spec: coreClient.OperationSpec
    ): Promise<AzureLargeInstancesDeleteResponse> => {
      return this.client.sendOperationRequest(args, spec);
    };
    const sendOperationFn = async (
      args: coreClient.OperationArguments,
...
const createOperationSpec: coreClient.OperationSpec = {
  ...
  requestBody: Parameters.azurelargeinstanceproperties,
  queryParameters: [Parameters.apiVersion],
  urlParameters: [
    Parameters.$host,
    Parameters.subscriptionId,
...
const deleteOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      headersMapper: Mappers.AzureLargeInstancesDeleteHeaders
    },
    201: {
      headersMapper: Mappers.AzureLargeInstancesDeleteHeaders
    },
