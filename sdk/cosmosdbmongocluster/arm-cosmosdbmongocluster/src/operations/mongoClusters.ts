...
import { CosmosDBMongoClusterManagementClient } from "../cosmosDBMongoClusterManagementClient";
import {
  SimplePollerLike,
  OperationState,
  createHttpPoller,
...
export class MongoClustersImpl implements MongoClusters {
  private readonly client: CosmosDBMongoClusterManagementClient;

  /**
   * Initialize a new instance of the class MongoClusters class.
   * @param client Reference to the service client
   */
  constructor(client: CosmosDBMongoClusterManagementClient) {
    this.client = client;
  }
