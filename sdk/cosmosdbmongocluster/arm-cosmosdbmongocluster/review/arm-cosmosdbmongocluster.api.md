## API Report File for "@azure/arm-cosmosdbmongocluster"
...
// @public (undocumented)
export class CosmosDBMongoClusterManagementClient extends coreClient.ServiceClient {
    // (undocumented)
    $host: string;
    constructor(credentials: coreAuth.TokenCredential, subscriptionId: string, options?: CosmosDBMongoClusterManagementClientOptionalParams);
    // (undocumented)
    apiVersion: string;
    // (undocumented)
...
// @public
export interface CosmosDBMongoClusterManagementClientOptionalParams extends coreClient.ServiceClientOptions {
    $host?: string;
    apiVersion?: string;
    endpoint?: string;
}
