...
**Features**
  ...
  - Interface LotsListByBillingAccountOptionalParams has a new optional parameter extendedProperties
  - Interface LotSummary has a new optional parameter extendedProperties
  - Interface LotSummary has a new optional parameter isEstimatedBalance
  - Interface LotSummary has a new optional parameter lotSource
  - Interface LotSummary has a new optional parameter lotType
  ...
  - Added Enum KnownLotType
  - Added Enum KnownOperationStatusType
  - Added Enum KnownOrganizationType
  - Enum KnownEventType has a new value CreditExpired
  - Enum KnownLotSource has a new value AwardedCredit
  - Enum KnownLotSource has a new value ServiceSpecificCredit
