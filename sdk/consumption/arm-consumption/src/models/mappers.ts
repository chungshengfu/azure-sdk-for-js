...
export const SavingsPlan: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "SavingsPlan",
    modelProperties: {
...
export const Balance: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      overageRefund: {
        serializedName: "properties.overageRefund",
        readOnly: true,
        type: {
          name: "Number",
        },
...
export const EventSummary: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      isEstimatedBalance: {
        serializedName: "properties.isEstimatedBalance",
        readOnly: true,
        type: {
          name: "Boolean",
        },
...
export const LotSummary: coreClient.CompositeMapper = {
  type: {
    ...
    modelProperties: {
      ...
      usedAmount: {
        serializedName: "properties.usedAmount",
        type: {
          name: "Composite",
          className: "Amount",
        },
      ...
      lotType: {
        serializedName: "properties.lotType",
        readOnly: true,
        type: {
          name: "String",
        },
      ...
      organizationType: {
        serializedName: "properties.OrganizationType",
        readOnly: true,
        type: {
          name: "String",
        },
...
export const LegacyReservationRecommendation: coreClient.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...
      lastUsageDate: {
        serializedName: "properties.lastUsageDate",
        readOnly: true,
        type: {
          name: "DateTime",
        },
      ...
      totalHours: {
        serializedName: "properties.totalHours",
        readOnly: true,
        type: {
          name: "Number",
        },
...
export let discriminators = {
  ...
  "LegacyReservationRecommendationProperties.Single":
    LegacySingleScopeReservationRecommendationProperties,
  "LegacyReservationRecommendationProperties.Shared":
    LegacySharedScopeReservationRecommendationProperties,
  "ModernReservationRecommendationProperties.Single":
    ModernSingleScopeReservationRecommendationProperties,
  "ModernReservationRecommendationProperties.Shared":
