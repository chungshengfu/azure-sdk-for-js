...
// @public
export interface DeploymentStackProperties extends ErrorResponse {
    actionOnUnmanage: ActionOnUnmanage;
    bypassStackOutOfSyncError?: boolean;
    readonly correlationId?: string;
    debugSetting?: DeploymentStacksDebugSetting;
...
// @public
export interface DeploymentStackValidateResult extends AzureResourceBase, ErrorResponse {
...
// @public
export interface ResourceReferenceExtended extends ResourceReference, ErrorResponse {
}
