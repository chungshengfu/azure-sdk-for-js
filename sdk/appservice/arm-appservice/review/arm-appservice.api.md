...
export interface StaticSites {
    ...
    beginPurgeStaticSite(resourceGroupName: string, name: string, options?: StaticSitesPurgeStaticSiteOptionalParams): Promise<SimplePollerLike<OperationState<void>, void>>;
    ...
    beginPurgeStaticSiteBuild(resourceGroupName: string, name: string, environmentName: string, options?: StaticSitesPurgeStaticSiteBuildOptionalParams): Promise<SimplePollerLike<OperationState<void>, void>>;
