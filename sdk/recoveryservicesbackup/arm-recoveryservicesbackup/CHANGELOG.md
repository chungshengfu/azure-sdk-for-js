...
**Features**
  ...
  - Added operation ProtectedItems.beginCreateOrUpdate
  - Added operation ProtectedItems.beginCreateOrUpdateAndWait
  - Added operation ProtectedItems.beginDelete
  - Added operation ProtectedItems.beginDeleteAndWait
  - Added operation ProtectionContainers.beginRegister
  - Added operation ProtectionContainers.beginRegisterAndWait
  - Added operation ProtectionContainers.beginUnregister
  - Added operation ProtectionContainers.beginUnregisterAndWait
  ...
  - Interface ProtectedItemsCreateOrUpdateOptionalParams has a new optional parameter resumeFrom
  - Interface ProtectedItemsCreateOrUpdateOptionalParams has a new optional parameter updateIntervalInMs
  - Interface ProtectedItemsDeleteOptionalParams has a new optional parameter resumeFrom
  - Interface ProtectedItemsDeleteOptionalParams has a new optional parameter updateIntervalInMs
  ...
  - Interface ProtectionContainersUnregisterOptionalParams has a new optional parameter resumeFrom
  - Interface ProtectionContainersUnregisterOptionalParams has a new optional parameter updateIntervalInMs
...
**Breaking Changes**
  ...
  - Removed operation ProtectedItems.createOrUpdate
  - Removed operation ProtectedItems.delete
  - Removed operation ProtectionContainers.register
  - Removed operation ProtectionContainers.unregister
