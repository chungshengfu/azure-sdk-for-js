...
export class UpdateImpl implements Update {
  ...
  async beginRecommendation(
    ...
    SimplePollerLike<
      OperationState<UpdateRecommendationResponse>,
      UpdateRecommendationResponse
    >
  > {
...
const recommendationOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/recommendations/{recommendationId}",
  httpMethod: "PATCH",
  responses: {
    200: {
