...
import {
  ...
  BusinessApplicationAgentsImpl,
  BusinessApplicationAgentImpl,
  SystemsImpl,
  BookmarksImpl,
...
export class SecurityInsights extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    this.businessApplicationAgents = new BusinessApplicationAgentsImpl(this);
    this.businessApplicationAgent = new BusinessApplicationAgentImpl(this);
    this.systems = new SystemsImpl(this);
