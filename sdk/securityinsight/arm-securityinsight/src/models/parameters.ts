...
export const billingStatisticName: OperationURLParameter = {
  parameterPath: "billingStatisticName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[A-Za-z0-9][A-Za-z0-9-]+[A-Za-z0-9]$"),
    },
    serializedName: "billingStatisticName",
    required: true,
    type: {
      name: "String",
    },
...
export const agentToUpsert: OperationParameter = {
  parameterPath: ["options", "agentToUpsert"],
  mapper: AgentMapper,
};

export const agentResourceName: OperationURLParameter = {
  parameterPath: "agentResourceName",
  mapper: {
    constraints: {
    ...
    serializedName: "agentResourceName",
    required: true,
    type: {
      name: "String",
    },
...
export const xMsClientWorkspaceId: OperationParameter = {
  parameterPath: ["options", "xMsClientWorkspaceId"],
  mapper: {
    serializedName: "x-ms-client-workspace-id",
    type: {
      name: "Uuid",
    },
  },
...
export const xMsClientObjectId: OperationParameter = {
  parameterPath: ["options", "xMsClientObjectId"],
  mapper: {
    serializedName: "x-ms-client-object-id",
    type: {
      name: "Uuid",
    },
  },
...
export const systemToUpsert: OperationParameter = {
  parameterPath: ["options", "systemToUpsert"],
  mapper: SystemMapper,
};

export const systemResourceName: OperationURLParameter = {
  parameterPath: "systemResourceName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[a-z0-9,-]*$"),
      MaxLength: 63,
    ...
    serializedName: "systemResourceName",
    required: true,
    type: {
      name: "String",
    },
