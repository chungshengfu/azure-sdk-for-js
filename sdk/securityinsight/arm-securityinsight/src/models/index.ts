...
export type SystemsConfigurationUnion =
...
export type SystemsConfigurationConnectorUnion =
  | SystemsConfigurationConnector
  | AbapOsConnector
  | JavaOsConnector
  | NetWeaverConnector;
export type PerformActionPayloadUnion =
...
/** Base Model for API authentication - support kinds: Microsoft.Azure.Sentinel.BizApps.SystemsApiService.Controllers.Preview.Version_2024_03_01.Models.Systems.SubModel.Enums.AuthenticationArmType values. */
...
/** Report the status of a specific action that was performed by the agent */
...
/** Known values of {@link KeyVaultAuthType} that the service accepts. */
 ...
 * {@link KnownKeyVaultAuthType} can be used interchangeably with KeyVaultAuthType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **ManagedIdentity** \
 * **ApplicationIdentity**
...
/** Known values of {@link SystemStatusType} that the service accepts. */
...
/**
 * Defines values for SystemStatusType. \
 * {@link KnownSystemStatusType} can be used interchangeably with SystemStatusType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Running** \
 * **Stopped**
...
/** Known values of {@link ConfigurationArmType} that the service accepts. */
...
/**
 * Defines values for ConfigurationArmType. \
 * {@link KnownConfigurationArmType} can be used interchangeably with ConfigurationArmType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Sap**
 */
...
/** Known values of {@link ListActionKind} that the service accepts. */
...
/**
 * Defines values for ListActionKind. \
 * {@link KnownListActionKind} can be used interchangeably with ListActionKind,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **LockUser** \
 * **UnlockUser**
...
/** Known values of {@link HttpsConfigurationArmType} that the service accepts. */
...
/**
 * Defines values for HttpsConfigurationArmType. \
 * {@link KnownHttpsConfigurationArmType} can be used interchangeably with HttpsConfigurationArmType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **HttpOnly** \
 * **HttpsWithSslVerification** \
...
/** Known values of {@link SapSystemArmType} that the service accepts. */
...
/**
 * Defines values for SapSystemArmType. \
 * {@link KnownSapSystemArmType} can be used interchangeably with SapSystemArmType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **NetWeaver** \
 * **JavaOs** \
...
/** Known values of {@link LogArmType} that the service accepts. */
...
/**
 * Defines values for LogArmType. \
 * {@link KnownLogArmType} can be used interchangeably with LogArmType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **AbapAuditLog** \
 * **AbapJobLog** \
...
/** Known values of {@link IngestionArmType} that the service accepts. */
...
/**
 * Defines values for IngestionArmType. \
 * {@link KnownIngestionArmType} can be used interchangeably with IngestionArmType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Full** \
 * **Incremental**
...
/** Known values of {@link LogStatusArmType} that the service accepts. */
...
/**
 * Defines values for LogStatusArmType. \
 * {@link KnownLogStatusArmType} can be used interchangeably with LogStatusArmType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Enabled** \
 * **Disabled**
...
/** Known values of {@link AuthenticationArmType} that the service accepts. */
...
/**
 * Defines values for AuthenticationArmType. \
 * {@link KnownAuthenticationArmType} can be used interchangeably with AuthenticationArmType,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **UsernamePassword** \
 * **Snc** \
...
/** Known values of {@link PerformActionKind} that the service accepts. */
...
/**
 * Defines values for PerformActionKind. \
 * {@link KnownPerformActionKind} can be used interchangeably with PerformActionKind,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Undo**
 */
...
/** Known values of {@link ActionStatus} that the service accepts. */
 ...
 * {@link KnownActionStatus} can be used interchangeably with ActionStatus,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Pending**: Actions is pending \
...
/** Optional parameters. */
export interface BusinessApplicationAgentsCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {
  /** The Business Application Agent */
  agentToUpsert?: Agent;
...
/** Optional parameters. */
export interface BusinessApplicationAgentsDeleteOptionalParams
  extends coreClient.OperationOptions {
  xMsClientWorkspaceId?: string;
}

/** Optional parameters. */
export interface BusinessApplicationAgentsListOptionalParams
  extends coreClient.OperationOptions {
  /** Filters the results, based on a Boolean condition. Optional. */
  filter?: string;
  /** Sorts the results. Optional. */
...
/** Optional parameters. */
export interface BusinessApplicationAgentsListNextOptionalParams
  extends coreClient.OperationOptions {
  xMsClientWorkspaceId?: string;
}
...
/** Optional parameters. */
export interface BusinessApplicationAgentGetOptionalParams
  extends coreClient.OperationOptions {
  xMsClientWorkspaceId?: string;
}
...
/** Optional parameters. */
export interface SystemsCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {
  xMsClientWorkspaceId?: string;
  xMsClientObjectId?: string;
  /** The system to upsert. */
...
/** Optional parameters. */
export interface SystemsDeleteOptionalParams
  extends coreClient.OperationOptions {
  xMsClientWorkspaceId?: string;
}

/** Optional parameters. */
export interface SystemsGetAllOptionalParams
  extends coreClient.OperationOptions {
  /** Filters the results, based on a Boolean condition. Optional. */
  filter?: string;
  /** Sorts the results. Optional. */
...
/** Optional parameters. */
export interface SystemsListActionsOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface SystemsPerformActionOptionalParams
  extends coreClient.OperationOptions {
  /** Anything */
  payload?: any;
}
...
/** Optional parameters. */
export interface SystemsReportActionStatusOptionalParams
  extends coreClient.OperationOptions {
  /** Anything */
  payload?: any;
}
...
/** Optional parameters. */
export interface SystemsGetAllNextOptionalParams
  extends coreClient.OperationOptions {
  xMsClientWorkspaceId?: string;
}
