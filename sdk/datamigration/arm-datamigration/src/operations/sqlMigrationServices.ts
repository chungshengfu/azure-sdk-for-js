...
import {
  ...
  SqlMigrationServicesMonitoringDataOptionalParams,
  SqlMigrationServicesMonitoringDataResponse,
  ValidateIR,
...
export class SqlMigrationServicesImpl implements SqlMigrationServices {
  ...
  monitoringData(
    resourceGroupName: string,
    sqlMigrationServiceName: string,
    options?: SqlMigrationServicesMonitoringDataOptionalParams
  ): Promise<SqlMigrationServicesMonitoringDataResponse> {
    return this.client.sendOperationRequest(
      { resourceGroupName, sqlMigrationServiceName, options },
      monitoringDataOperationSpec
    );
  }
...
const monitoringDataOperationSpec: coreClient.OperationSpec = {
  path:
