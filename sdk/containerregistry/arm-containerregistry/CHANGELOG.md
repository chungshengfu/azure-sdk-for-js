...
**Features**
  ...
  - Added operation Registries.checkCacheRuleArtifactSyncEstimate
  ...
  - Added Interface ArtifactSyncEstimateResult
  - Added Interface ArtifactSyncScopeFilterProperties
  - Added Interface AuthCredential
  - Added Interface AzureADAuthenticationAsArmPolicy
  - Added Interface CacheRule
  - Added Interface CacheRuleArtifactSyncEstimateResult
  ...
  - Added Interface RegistriesCheckCacheRuleArtifactSyncEstimateOptionalParams
  ...
  - Added Type Alias ArtifactSyncScopeFilterType
  - Added Type Alias ArtifactSyncStatus
  ...
  - Added Type Alias RegistriesCheckCacheRuleArtifactSyncEstimateResponse
  - Added Type Alias TlsStatus
  - Interface ImportSource has a new optional parameter cacheRuleResourceId
  ...
  - Added Enum KnownArtifactSyncScopeFilterType
  - Added Enum KnownArtifactSyncStatus
