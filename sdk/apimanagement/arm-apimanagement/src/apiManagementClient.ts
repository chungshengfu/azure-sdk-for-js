...
import {
  ...
  ApiManagementGatewayConfigConnectionImpl,
  GroupImpl,
  GroupUserImpl,
...
export class ApiManagementClient extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    this.apiManagementGateway = new ApiManagementGatewayImpl(this);
    ...
    this.apiManagementGatewayConfigConnection =
      new ApiManagementGatewayConfigConnectionImpl(this);
