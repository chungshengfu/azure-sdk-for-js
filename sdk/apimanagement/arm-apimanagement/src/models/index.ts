...
export interface GatewayConfigConnectionBaseProperties {
  /**
   * The current provisioning state of the API Management gateway config connection which can be one of the following: Created/Activating/Succeeded/Updating/Failed/Stopped/Terminating/TerminationFailed/Deleted.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly provisioningState?: string;
  ...
  sourceId?: string;
  /**
   * The hostname of the data-plane gateway to which requests can be sent.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly hostname?: string[];
}
...
/** Properties of an API Management gateway config connection resource. */
export interface ApiManagementGatewayConfigConnectionProperties
  extends GatewayConfigConnectionBaseProperties {}

/** A single API Management gateway resource in List or Get response. */
export interface ApiManagementGatewayConfigConnectionResource
  extends ApimResourceAutoGenerated {
  /**
   * ETag of the resource.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
