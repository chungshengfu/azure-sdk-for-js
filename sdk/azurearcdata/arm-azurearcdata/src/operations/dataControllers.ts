...
export class DataControllersImpl implements DataControllers {
  ...
  private async *listInSubscriptionPagingPage(
    ...
    let result: DataControllersListInSubscriptionResponse;
  ...
  public listInGroup(
    ...
    return {
      ...
      byPage: (settings?: PageSettings) => {
        ...
        return this.listInGroupPagingPage(resourceGroupName, options, settings);
      },
    };
  }
  ...
  private async *listInGroupPagingPage(
    ...
    let result: DataControllersListInGroupResponse;
    let continuationToken = settings?.continuationToken;
    if (!continuationToken) {
      result = await this._listInGroup(resourceGroupName, options);
      let page = result.value || [];
      continuationToken = result.nextLink;
      setContinuationToken(page, continuationToken);
      yield page;
  ...
  > {
    ...
    const lro = createLroSpec({
      ...
      spec: putDataControllerOperationSpec,
    });
  ...
  async beginDeleteDataController(
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, dataControllerName, options },
      spec: deleteDataControllerOperationSpec,
    });
  ...
  > {
    ...
    const lro = createLroSpec({
      ...
      spec: patchDataControllerOperationSpec,
    });
    const poller = await createHttpPoller<
      DataControllersPatchDataControllerResponse,
      OperationState<DataControllersPatchDataControllerResponse>
