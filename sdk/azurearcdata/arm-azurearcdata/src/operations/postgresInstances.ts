...
export class PostgresInstancesImpl implements PostgresInstances {
  ...
  private async *listPagingPage(
    ...
    let result: PostgresInstancesListResponse;
  ...
  private async *listByResourceGroupPagingPage(
    ...
    let result: PostgresInstancesListByResourceGroupResponse;
    let continuationToken = settings?.continuationToken;
    if (!continuationToken) {
  ...
  > {
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, postgresInstanceName, resource, options },
  ...
  async beginDelete(
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, postgresInstanceName, options },
