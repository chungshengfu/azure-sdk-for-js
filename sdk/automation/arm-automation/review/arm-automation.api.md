...
export class AutomationClient extends coreClient.ServiceClient {
    ...
    // (undocumented)
    deletedRunbooks: DeletedRunbooks;
    // (undocumented)
...
export interface DeletedRunbooks {
    listByAutomationAccount(resourceGroupName: string, automationAccountName: string, options?: DeletedRunbooksListByAutomationAccountOptionalParams): PagedAsyncIterableIterator<DeletedRunbook>;
}

// @public
export interface DeletedRunbooksListByAutomationAccountNextOptionalParams extends coreClient.OperationOptions {
}

// @public
export type DeletedRunbooksListByAutomationAccountNextResponse = DeletedRunbookListResult;

// @public
export interface DeletedRunbooksListByAutomationAccountOptionalParams extends coreClient.OperationOptions {
}

// @public
export type DeletedRunbooksListByAutomationAccountResponse = DeletedRunbookListResult;
