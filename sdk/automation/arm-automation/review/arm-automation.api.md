...
export interface Packages {
    listByRuntimeEnvironment(resourceGroupName: string, automationAccountName: string, runtimeEnvironmentName: string, options?: PackagesListByRuntimeEnvironmentOptionalParams): PagedAsyncIterableIterator<Package>;
}

// @public
export interface PackagesListByRuntimeEnvironmentNextOptionalParams extends coreClient.OperationOptions {
}
...
// @public
export interface PackagesListByRuntimeEnvironmentOptionalParams extends coreClient.OperationOptions {
}
