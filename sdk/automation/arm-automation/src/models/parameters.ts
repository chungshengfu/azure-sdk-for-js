...
import {
  ...
  PackageCreateOrUpdateParameters as PackageCreateOrUpdateParametersMapper,
  ...
  RuntimeEnvironmentUpdateParameters as RuntimeEnvironmentUpdateParametersMapper,
  RuntimeEnvironment as RuntimeEnvironmentMapper,
...
export const automationAccountName1: OperationURLParameter = {
  parameterPath: "automationAccountName",
  mapper: {
    constraints: {
...
export const hybridRunbookWorkerCreationParameters1: OperationParameter = {
  parameterPath: ["options", "hybridRunbookWorkerCreationParameters"],
  mapper: HybridRunbookWorkerCreateParametersMapper
};
...
export const runtimeEnvironmentName: OperationURLParameter = {
  parameterPath: "runtimeEnvironmentName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[a-zA-Z][a-zA-Z-_0-9]*$")
    },
...
export const parameters22: OperationParameter = {
  parameterPath: "parameters",
  mapper: PackageCreateOrUpdateParametersMapper
};
...
export const parameters30: OperationParameter = {
  parameterPath: "parameters",
  mapper: RuntimeEnvironmentUpdateParametersMapper
};

export const parameters31: OperationParameter = {
  parameterPath: "parameters",
  mapper: RuntimeEnvironmentMapper
};
