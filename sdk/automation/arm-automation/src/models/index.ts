...
export interface RuntimeEnvironmentUpdateParameters {
  ...
  defaultPackages?: { [propertyName: string]: string };
}
...
/** Known values of {@link PackageProvisioningState} that the service accepts. */
...
/**
 * Defines values for PackageProvisioningState. \
...
/** Optional parameters. */
export interface PackagesListByRuntimeEnvironmentOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listByRuntimeEnvironment operation. */
export type PackagesListByRuntimeEnvironmentResponse = PackageListResult;

/** Optional parameters. */
export interface PackagesListByRuntimeEnvironmentNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listByRuntimeEnvironmentNext operation. */
export type PackagesListByRuntimeEnvironmentNextResponse = PackageListResult;
...
/** Optional parameters. */
export interface RuntimeEnvironmentsListByAutomationAccountOptionalParams
  extends coreClient.OperationOptions {}
