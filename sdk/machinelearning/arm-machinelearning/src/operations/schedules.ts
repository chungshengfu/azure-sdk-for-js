...
const triggerOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/schedules/{name}/trigger",
  httpMethod: "POST",
  responses: {
    200: {
      bodyMapper: Mappers.TriggerRunSubmissionDto,
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
    },
