...
export class LabelingJobsImpl implements LabelingJobs {
  ...
  > {
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, workspaceName, id, body, options },
  ...
  /**
   * Export labels from a labeling job (asynchronous). Using the URL in the Location header, the status
  ...
  > {
    ...
    const lro = createLroSpec({
      sendOperationFn,
      args: { resourceGroupName, workspaceName, id, body, options },
      spec: exportLabelsOperationSpec,
    });
    const poller = await createHttpPoller<
      LabelingJobsExportLabelsResponse,
      OperationState<LabelingJobsExportLabelsResponse>
...
const pauseOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.LabelingJobProperties,
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
    },
