...
import {
  ...
  GetSnapshotOperationDetailsParameters,
  GetLabelsParameters,
...
import {
  ...
  GetSnapshotOperationDetails200Response,
  GetSnapshotOperationDetailsDefaultResponse,
...
export interface GetSnapshotOperationDetails {
  ...
  get(
    options: GetSnapshotOperationDetailsParameters,
  ): StreamableMethod<
    | GetSnapshotOperationDetails200Response
    | GetSnapshotOperationDetailsDefaultResponse
  >;
