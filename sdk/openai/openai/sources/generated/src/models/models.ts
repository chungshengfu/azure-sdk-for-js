...
export interface AudioTranscriptionOptions {
  ...
  responseFormat?:
    | AudioTranscriptionPlainTextFormat
    | AudioTranscriptionJsonFormat;
  /**
...
/** "text", "srt", "vtt" */
export type AudioTranscriptionPlainTextFormat = string;
/** Defines available options for the underlying response format of output transcription information. */
/** "json", "verbose_json" */
export type AudioTranscriptionJsonFormat = string;

/** The configuration information for an audio transcription request. */
export interface AudioTranscriptionPlainTextOptions
  extends AudioTranscriptionOptions {
  /** The requested format of the transcription response data, which will influence the content and detail of the result. */
  responseFormat?: AudioTranscriptionPlainTextFormat;
}

/** The configuration information for an audio transcription request. */
export interface AudioTranscriptionJsonOptions
  extends AudioTranscriptionOptions {
  /** The requested format of the transcription response data, which will influence the content and detail of the result. */
  responseFormat?: AudioTranscriptionJsonFormat;
}
