...
export interface ApiDefinitions {
    beginExportSpecification(resourceGroupName: string, serviceName: string, options?: ApiDefinitionsExportSpecificationOptionalParams): Promise<SimplePollerLike<OperationState<ApiDefinitionsExportSpecificationResponse>, ApiDefinitionsExportSpecificationResponse>>;
    beginExportSpecificationAndWait(resourceGroupName: string, serviceName: string, options?: ApiDefinitionsExportSpecificationOptionalParams): Promise<ApiDefinitionsExportSpecificationResponse>;
    beginImportSpecification(resourceGroupName: string, serviceName: string, payload: ApiSpecImportRequest, options?: ApiDefinitionsImportSpecificationOptionalParams): Promise<SimplePollerLike<OperationState<void>, void>>;
    beginImportSpecificationAndWait(resourceGroupName: string, serviceName: string, payload: ApiSpecImportRequest, options?: ApiDefinitionsImportSpecificationOptionalParams): Promise<void>;
...
export class AzureAPICenter extends coreClient.ServiceClient {
    ...
    beginImportFromApim(resourceGroupName: string, serviceName: string, payload: ImportFromApimRequest, options?: ImportFromApimOptionalParams): Promise<SimplePollerLike<OperationState<void>, void>>;
    beginImportFromApimAndWait(resourceGroupName: string, serviceName: string, payload: ImportFromApimRequest, options?: ImportFromApimOptionalParams): Promise<void>;
    // (undocumented)
...
// @public
export interface ImportFromApimOptionalParams extends coreClient.OperationOptions {
    resumeFrom?: string;
    updateIntervalInMs?: number;
}
