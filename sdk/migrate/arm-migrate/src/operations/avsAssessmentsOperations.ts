...
import { AvsAssessmentsOperations } from "../operationsInterfaces";
...
import {
  AvsAssessment,
  AvsAssessmentsOperationsListByGroupNextOptionalParams,
  AvsAssessmentsOperationsListByGroupOptionalParams,
  AvsAssessmentsOperationsListByGroupResponse,
  ...
  AvsAssessmentsOperationsListByGroupNextResponse
} from "../models";

/// <reference lib="esnext.asynciterable" />
/** Class containing AvsAssessmentsOperations operations. */
export class AvsAssessmentsOperationsImpl implements AvsAssessmentsOperations {
  ...
  ): AsyncIterableIterator<AvsAssessment[]> {
    let result: AvsAssessmentsOperationsListByGroupResponse;
  ...
  private _listByGroup(
    ...
    groupName: string,
    options?: AvsAssessmentsOperationsListByGroupOptionalParams
  ): Promise<AvsAssessmentsOperationsListByGroupResponse> {
  ...
  private _listByGroupNext(
    ...
    groupName: string,
    nextLink: string,
    options?: AvsAssessmentsOperationsListByGroupNextOptionalParams
  ): Promise<AvsAssessmentsOperationsListByGroupNextResponse> {
    return this.client.sendOperationRequest(
...
const listByGroupOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.AvsAssessmentListResult
    },
    default: {
...
const getOperationSpec: coreClient.OperationSpec = {
  path:
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/groups/{groupName}/avsAssessments/{assessmentName}",
  httpMethod: "GET",
  responses: {
    200: {
      bodyMapper: Mappers.AvsAssessment
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }
...
const downloadUrlOperationSpec: coreClient.OperationSpec = {
  path:
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/assessmentProjects/{projectName}/groups/{groupName}/avsAssessments/{assessmentName}/downloadUrl",
  httpMethod: "POST",
  responses: {
    200: {
