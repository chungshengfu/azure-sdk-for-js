...
export interface LoadTestConfigurationOutput {
  ...
  /** Locust test configuration, in case kind is Locust */
  locustConfiguration?: LocustConfigurationOutput;
...
/** Locust test configuration, in case kind is Locust */
export interface LocustConfigurationOutput {
  /** Number of concurrent virtual users */
  users?: number;
  /** Test run duration in seconds. */
  durationInSeconds?: number;
  /** Number of users to spawn every second. */
  spawnRate?: number;
}
