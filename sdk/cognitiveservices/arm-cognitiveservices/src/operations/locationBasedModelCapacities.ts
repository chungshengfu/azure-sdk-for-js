  ...
  implements LocationBasedModelCapacities
{
  ...
  private _listNext(
    ...
    return this.client.sendOperationRequest(
      { location, modelFormat, modelName, modelVersion, nextLink, options },
...
const listOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/providers/Microsoft.CognitiveServices/locations/{location}/modelCapacities/{model-format}/{model-name}/{model-version}",
  httpMethod: "GET",
  responses: {
    200: {
