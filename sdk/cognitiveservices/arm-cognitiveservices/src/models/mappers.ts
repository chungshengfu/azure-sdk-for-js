...
export const ModelPropertiesListResult: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ModelPropertiesListResult",
    modelProperties: {
      nextLink: {
        serializedName: "nextLink",
        type: {
...
export const RaiBlocklistItemRequestBody: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "RaiBlocklistItemRequestBody",
    modelProperties: {
      name: {
        serializedName: "name",
        type: {
  ...
  type: {
    ...
    modelProperties: {
      ...
      properties: {
        ...
        type: {
          name: "Composite",
          className: "NetworkSecurityPerimeterAccessRulePropeties",
        },
      },
    },
  },
...
export const NetworkSecurityPerimeterAccessRulePropeties: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "NetworkSecurityPerimeterAccessRulePropeties",
          ...
          type: {
            ...
            element: {
              type: {
                name: "Composite",
                className:
                  "NetworkSecurityPerimeterAccessRulePropetiesSubscriptionsItem",
              },
            },
          },
        },
...
export const NetworkSecurityPerimeterAccessRulePropetiesSubscriptionsItem: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "NetworkSecurityPerimeterAccessRulePropetiesSubscriptionsItem",
      modelProperties: {
        id: {
          serializedName: "id",
          type: {
