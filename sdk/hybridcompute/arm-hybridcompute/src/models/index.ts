...
export enum KnownPublicNetworkAccessType {
  ...
  Disabled = "Disabled",
  /** Azure Arc agent communication with Azure Arc services over public (internet) is enforced by NSP */
 ...
 * **SecuredByPerimeter**: Azure Arc agent communication with Azure Arc services over public (internet) is enforced by NSP
 */
