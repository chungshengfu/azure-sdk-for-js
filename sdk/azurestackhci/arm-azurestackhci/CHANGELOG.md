...
**Breaking Changes**
  ...
  - Class AzureStackHCIClient has a new required parameter offers
  - Class AzureStackHCIClient has a new required parameter publishers
  - Class AzureStackHCIClient has a new required parameter skus
  - Class AzureStackHCIClient has a new required parameter updateRuns
  - Class AzureStackHCIClient has a new required parameter updates
  - Class AzureStackHCIClient has a new required parameter updateSummariesOperations
