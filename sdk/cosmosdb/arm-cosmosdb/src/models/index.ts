...
/** Defines headers for CassandraClusters_invokeAsyncCommand operation. */
...
/** Optional parameters. */
export interface CassandraClustersInvokeAsyncCommandOptionalParams
  extends coreClient.OperationOptions {
  /** Delay to wait until next poll, in milliseconds. */
  updateIntervalInMs?: number;
  /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
...
/** Contains response data for the invokeAsyncCommand operation. */
...
/** Optional parameters. */
export interface CassandraClustersGetAsyncCommandOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the getAsyncCommand operation. */
