...
export interface ClusterResourceProperties {
  ...
  /**
   * If AzureConnectionMethod is VPN, the resource id of the private link resource that is used establish a private link to the Azure services used by the cluster
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
  readonly privateLinkResourceId?: string;
  /** If AzureConnectionMethod is VPN, the list of subscriptions that are automatically approved to connect to the private link resource that is used establish a private link to the Azure services used by the cluster */
  privateLinkAutoApproveSubscriptions?: string[];
...
export interface DataCenterResourceProperties {
  ...
  /** If AzureConnectionMethod is VPN, IP address of the private endpoint connected to the clusters private link to access Azure Services. */
