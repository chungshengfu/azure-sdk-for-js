...
**Features**
  ...
  - Added Interface SqlServiceResourceCreateUpdateParameters
  ...
  - Type of parameter serviceType of interface ServiceResourceProperties is changed from "DataTransfer" | "SqlDedicatedGateway" | "GraphAPICompute" | "MaterializedViewsBuilder" to "DataTransfer" | "SqlServiceResourceCreateUpdateParameters" | "SqlDedicatedGateway" | "GraphAPICompute" | "MaterializedViewsBuilder"
