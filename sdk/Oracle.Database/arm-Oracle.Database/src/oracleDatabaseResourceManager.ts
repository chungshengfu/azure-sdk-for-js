...
import { OracleDatabaseResourceManagerOptionalParams } from "./models";
...
export class OracleDatabaseResourceManager extends coreClient.ServiceClient {
  ...
  /**
   * Initializes a new instance of the OracleDatabaseResourceManager class.
  ...
  constructor(
    ...
    subscriptionId: string,
    options?: OracleDatabaseResourceManagerOptionalParams,
  ) {
    ...
    const defaults: OracleDatabaseResourceManagerOptionalParams = {
      requestContentType: "application/json; charset=utf-8",
      credential: credentials,
    };

    const packageDetails = `azsdk-js-arm-Oracle.Database/1.0.0-beta.1`;
