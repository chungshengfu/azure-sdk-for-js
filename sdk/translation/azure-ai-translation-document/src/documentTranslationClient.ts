 ...
 * @param endpoint - Supported document Translation endpoint, protocol and hostname, for example: https://{TranslatorResourceName}.cognitiveservices.azure.com/translator.
...
export default function createClient(
  ...
  const baseUrl = options.baseUrl ?? `${endpoint}/translator`;
