...
export const dataScannerName: OperationURLParameter = {
  parameterPath: "dataScannerName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[a-z][a-z0-9]*$"),
    },
    serializedName: "dataScannerName",
    required: true,
    type: {
      name: "String",
    },
...
export const dataScannerName1: OperationURLParameter = {
  parameterPath: "dataScannerName",
  mapper: {
    serializedName: "dataScannerName",
    required: true,
