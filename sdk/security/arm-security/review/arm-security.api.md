...
export interface DataScanners {
    createOrUpdate(dataScannerName: string, options?: DataScannersCreateOrUpdateOptionalParams): Promise<DataScannersCreateOrUpdateResponse>;
    delete(dataScannerName: string, options?: DataScannersDeleteOptionalParams): Promise<void>;
    get(dataScannerName: string, options?: DataScannersGetOptionalParams): Promise<DataScannersGetResponse>;
    listBySubscription(options?: DataScannersListBySubscriptionOptionalParams): PagedAsyncIterableIterator<DataScanner>;
}

// @public
export interface DataScannersCreateOrUpdateOptionalParams extends coreClient.OperationOptions {
}

// @public
export type DataScannersCreateOrUpdateResponse = DataScanner;

// @public
export interface DataScannersDeleteOptionalParams extends coreClient.OperationOptions {
}

// @public
export interface DataScannersGetOptionalParams extends coreClient.OperationOptions {
}

// @public
export type DataScannersGetResponse = DataScanner;

// @public
export interface DataScannersList {
    readonly nextLink?: string;
    readonly value?: DataScanner[];
}

// @public
export interface DataScannersListBySubscriptionNextOptionalParams extends coreClient.OperationOptions {
}

// @public
export type DataScannersListBySubscriptionNextResponse = DataScannersList;

// @public
export interface DataScannersListBySubscriptionOptionalParams extends coreClient.OperationOptions {
}

// @public
export type DataScannersListBySubscriptionResponse = DataScannersList;
