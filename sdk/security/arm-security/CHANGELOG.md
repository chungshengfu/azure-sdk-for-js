...
**Features**
  ...
  - Enum KnownRecommendationType has a new value BinarySignature
  - Enum KnownRecommendationType has a new value File
  - Enum KnownRecommendationType has a new value FileHash
  - Enum KnownRecommendationType has a new value ProductSignature
  - Enum KnownRecommendationType has a new value PublisherSignature
  - Enum KnownRecommendationType has a new value VersionAndAboveSignature
