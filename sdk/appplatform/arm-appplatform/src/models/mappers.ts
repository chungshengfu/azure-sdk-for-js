  ...
  type: {
    ...
    modelProperties: {
      environmentVariables: {
        ...
        type: {
          name: "Composite",
          className: "JobExecutionTemplateEnvironmentVariables",
        },
      },
      replicaTimeout: {
...
export const JobExecutionTemplateEnvironmentVariables: coreClient.CompositeMapper =
  {
    type: {
      name: "Composite",
      className: "JobExecutionTemplateEnvironmentVariables",
...
export const JobExecutionProperties: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
