...
**Features**
  ...
  - Added Interface MetadataAutoGenerated
  - Added Interface MetadataAutoGenerated2
  ...
  - Added Interface ResourceForUpdateAutoGenerated
  - Added Interface ResourceForUpdateDceProperties
  - Added Interface ResourceForUpdateDcePropertiesFailoverConfiguration
  - Added Interface ResourceForUpdateDcePropertiesMetadata
  - Added Interface ResourceForUpdateIdentity
  - Added Interface ResourceForUpdateProperties
  ...
  - Interface ResourceForUpdate has a new optional parameter kind
  - Interface ResourceForUpdate has a new optional parameter properties
...
**Breaking Changes**
  ...
  - Type of parameter body of interface DataCollectionRulesUpdateOptionalParams is changed from ResourceForUpdate to ResourceForUpdateAutoGenerated
