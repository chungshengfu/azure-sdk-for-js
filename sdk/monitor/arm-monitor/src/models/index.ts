...
export interface DataCollectionEndpointResource {
  ...
  /** Failover configuration on this endpoint. This property can only be updated by Log Analytics Control Plane (LACP) for DCE with Log Analytics Destination */
  failoverConfiguration?: DataCollectionEndpointFailoverConfiguration;
  /** Metadata for the resource. This property can only be updated by Log Analytics Control Plane (LACP) for DCE with Log Analytics Destination */
...
export interface ResourceForUpdate {
  ...
  properties?: ResourceForUpdateProperties;
}

export interface ResourceForUpdateDceProperties {
  /** Failover configuration */
  failoverConfiguration?: ResourceForUpdateDcePropertiesFailoverConfiguration;
  /** Metadata for the resource */
  metadata?: ResourceForUpdateDcePropertiesMetadata;
}
...
/** Metadata about the resource */
export interface MetadataAutoGenerated {
  /**
   * Azure offering managing this resource on-behalf-of customer.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
/** Metadata about the resource */
export interface MetadataAutoGenerated2 {
  /**
   * Azure offering managing this resource on-behalf-of customer.
   * NOTE: This property will not be serialized. It can only be populated by the server.
   */
...
/** Definition of ARM tracked top level resource properties for update operation. */
export interface ResourceForUpdateAutoGenerated {
  /** Resource tags. */
  tags?: { [propertyName: string]: string };
  /** Managed Service Identity. */
  identity?: ResourceForUpdateIdentity;
...
/** Failover configuration */
export interface ResourceForUpdateDcePropertiesFailoverConfiguration
  extends FailoverConfigurationSpec {}
...
/** Metadata for the resource */
export interface ResourceForUpdateDcePropertiesMetadata extends Metadata {}
...
/** Properties of the Data Collection Endpoint that are being updated. */
export interface ResourceForUpdateProperties
  extends ResourceForUpdateDceProperties {}
...
/** Metadata about the resource */
export interface DataCollectionRuleMetadata extends MetadataAutoGenerated2 {}
