...
export interface SubscriptionScopeMetricsRequestBodyParameters {
   ...
   */
  interval?: string;
  /** The names of the metrics (comma separated) to retrieve. Special case: If a metricname itself has a comma in it then use %2 to indicate it. Eg: 'Metric,Name1' should be **'Metric%2Name1'**. At most 20 metric names can be specified. */
  metricNames?: string;
