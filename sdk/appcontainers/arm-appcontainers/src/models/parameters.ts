...
export const containerAppName2: OperationURLParameter = {
  parameterPath: "containerAppName",
  mapper: {
    constraints: {
...
export const labelsName: OperationURLParameter = {
  parameterPath: "labelsName",
  mapper: {
    constraints: {
      Pattern: new RegExp("^[a-z][a-z0-9]*$"),
    },
...
export const labelsEnvelope: OperationParameter = {
  parameterPath: "labelsEnvelope",
  mapper: LabelsMapper,
};
