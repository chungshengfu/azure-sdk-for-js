...
/** Optional parameters. */
export interface ContainerAppsSessionPoolSessionsGenerateSessionsOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the generateSessions operation. */
export type ContainerAppsSessionPoolSessionsGenerateSessionsResponse =
  SessionCollection;

/** Optional parameters. */
export interface ContainerAppsSessionPoolSessionsGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface ContainerAppsSessionPoolSessionsListBySessionPoolOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listBySessionPool operation. */
export type ContainerAppsSessionPoolSessionsListBySessionPoolResponse =
  SessionCollection;

/** Optional parameters. */
export interface ContainerAppsSessionPoolSessionsGenerateSessionsNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the generateSessionsNext operation. */
export type ContainerAppsSessionPoolSessionsGenerateSessionsNextResponse =
  SessionCollection;

/** Optional parameters. */
export interface ContainerAppsSessionPoolSessionsListBySessionPoolNextOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the listBySessionPoolNext operation. */
export type ContainerAppsSessionPoolSessionsListBySessionPoolNextResponse =
  SessionCollection;
