...
**Features**
  ...
  - Added operation group ContainerAppsSessionPoolSessions
  ...
  - Added Interface CodeExecutionConfiguration
  ...
  - Added Interface ContainerAppsSessionPoolSessionsGenerateSessionsNextOptionalParams
  - Added Interface ContainerAppsSessionPoolSessionsGenerateSessionsOptionalParams
  - Added Interface ContainerAppsSessionPoolSessionsGetOptionalParams
  - Added Interface ContainerAppsSessionPoolSessionsListBySessionPoolNextOptionalParams
  - Added Interface ContainerAppsSessionPoolSessionsListBySessionPoolOptionalParams
  ...
  - Added Interface GenerateSessionsRequest
  ...
  - Added Interface Session
  - Added Interface SessionAuthConfiguration
  - Added Interface SessionCollection
  ...
  - Added Interface SessionTemplate
  ...
  - Added Type Alias ContainerAppsSessionPoolSessionsGenerateSessionsNextResponse
  - Added Type Alias ContainerAppsSessionPoolSessionsGenerateSessionsResponse
  - Added Type Alias ContainerAppsSessionPoolSessionsGetResponse
  - Added Type Alias ContainerAppsSessionPoolSessionsListBySessionPoolNextResponse
  - Added Type Alias ContainerAppsSessionPoolSessionsListBySessionPoolResponse
