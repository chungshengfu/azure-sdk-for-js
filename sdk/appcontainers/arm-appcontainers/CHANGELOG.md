...
## 3.0.0-beta.1 (2024-02-23)
    
**Features**

  - Added operation group AppResiliencyOperations
  - Added operation group AppSpaceResources
  - Added operation group AppSpaces
  ...
  - Added Interface AppSpace
  - Added Interface AppSpacePatch
  - Added Interface AppSpaceProperties
  - Added Interface AppSpaceResource
  - Added Interface AppSpaceResourcePatch
  - Added Interface AppSpaceResourceProperties
  - Added Interface AppSpaceResourcesCollection
  - Added Interface AppSpaceResourcesCreateOrUpdateOptionalParams
  - Added Interface AppSpaceResourcesDeleteOptionalParams
  - Added Interface AppSpaceResourcesGetOptionalParams
  - Added Interface AppSpaceResourcesListByAppSpaceNextOptionalParams
  - Added Interface AppSpaceResourcesListByAppSpaceOptionalParams
  - Added Interface AppSpaceResourcesUpdateOptionalParams
  - Added Interface AppSpacesCollection
  - Added Interface AppSpacesCreateOrUpdateOptionalParams
  - Added Interface AppSpacesDeleteOptionalParams
  - Added Interface AppSpacesGetOptionalParams
  - Added Interface AppSpacesListByResourceGroupNextOptionalParams
  - Added Interface AppSpacesListByResourceGroupOptionalParams
  - Added Interface AppSpacesListBySubscriptionNextOptionalParams
  - Added Interface AppSpacesListBySubscriptionOptionalParams
  - Added Interface AppSpacesUpdateOptionalParams
  ...
  - Added Interface DeploymentInformation
  ...
  - Added Interface MetadataProperty
  ...
  - Added Interface RepositoryInformation
  ...
  - Added Type Alias AppSpaceResourceLabel
  - Added Type Alias AppSpaceResourcesCreateOrUpdateResponse
  - Added Type Alias AppSpaceResourcesGetResponse
  - Added Type Alias AppSpaceResourcesListByAppSpaceNextResponse
  - Added Type Alias AppSpaceResourcesListByAppSpaceResponse
  - Added Type Alias AppSpaceResourcesUpdateResponse
  - Added Type Alias AppSpacesCreateOrUpdateResponse
  - Added Type Alias AppSpacesGetResponse
  - Added Type Alias AppSpacesListByResourceGroupNextResponse
  - Added Type Alias AppSpacesListByResourceGroupResponse
  - Added Type Alias AppSpacesListBySubscriptionNextResponse
  - Added Type Alias AppSpacesListBySubscriptionResponse
  - Added Type Alias AppSpacesUpdateResponse
  ...
  - Added Enum KnownAppSpaceResourceLabel
